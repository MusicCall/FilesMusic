...
@wizardbot.on(admin_cmd(pattern="sendto(?: |$)(.*)", command="sendto"))
@wizardbot.on(sudo_cmd(pattern="sendto(?: |$)(.*)", command="sendto", allow_sudo=True))
...
@wizardbot.on(admin_cmd(pattern="fwdto(?: |$)(.*)", command="fwdto"))
@wizardbot.on(sudo_cmd(pattern="fwdto(?: |$)(.*)", command="fwdto", allow_sudo=True))
async def catbroadcast_send(event):
    if event.fwd_from:
        return
    catinput_str = event.pattern_match.group(1)
...
@wizardbot.on(admin_cmd(pattern="addto(?: |$)(.*)", command="addto"))
@wizardbot.on(sudo_cmd(pattern="addto(?: |$)(.*)", command="addto", allow_sudo=True))
...
@wizardbot.on(admin_cmd(pattern="rmfrom(?: |$)(.*)", command="rmfrom"))
@wizardbot.on(sudo_cmd(pattern="rmfrom(?: |$)(.*)", command="rmfrom", allow_sudo=True))
...
@wizardbot.on(admin_cmd(pattern="list(?: |$)(.*)", command="list"))
@wizardbot.on(sudo_cmd(pattern="list(?: |$)(.*)", command="list", allow_sudo=True))
...
@wizardbot.on(admin_cmd(pattern="listall$", command="listall"))
@wizardbot.on(sudo_cmd(pattern="listall$", command="listall", allow_sudo=True))
async def catbroadcast_list(event):
    if event.fwd_from:
        return
...
@wizardbot.on(admin_cmd(pattern="frmfrom(?: |$)(.*)", command="frmfrom"))
@wizardbot.on(sudo_cmd(pattern="frmfrom(?: |$)(.*)", command="frmfrom", allow_sudo=True))
async def catbroadcast_remove(event):
    if event.fwd_from:
        return
    catinput_str = event.pattern_match.group(1)
...
@wizardbot.on(admin_cmd(pattern="delc(?: |$)(.*)", command="delc"))
@wizardbot.on(sudo_cmd(pattern="delc(?: |$)(.*)", command="delc", allow_sudo=True))
